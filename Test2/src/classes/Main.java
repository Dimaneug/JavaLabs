...
public class Main {
    ...
    public static long params[][] = new long[2][5]; //������ ��������
    public static Color col[] = {new Color(102, 165, 173), new Color(7, 87, 91)};
    ...
    public static void main(String[] args)  {
        ...
        while (true){
            System.out.println("Графики");

            int var = S.nextInt();
            switch(var)
            {
                case 0:
                    //Log.log(Level.INFO, "���������� ��������� � {0}",LocalTime.now());
                    S.close();
                    return;
                case 1:
                    new DrawGraf("Test1",true).setVisible(true);
                    new DrawGraf("Test2", false).setVisible(true);
                    break;
                case 2:
                    break;
            }
