...
public class ForestArray {
    ...
    public static long [][] AddedMedian() {
        long[][] added = new long[2][5];
        for (int i = 0; i < 5; i++) {
            added[0][i] = Added[0][i];
            added[1][i] = Added[1][i];
        }
    ...
    public static long [][] RemovedMedian() {
        long [][] removed = new long[2][5];
        for (int i = 0; i < 5; i++) {
            removed[0][i] = Removed[0][i];
            removed[1][i] = Removed[1][i];
        }
        return removed;
    }
